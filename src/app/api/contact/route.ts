...
const generateEmailContent = (data: ContactForm) => {
  // Create text content for Nodemailer
  ...
  // Create HTML content for Nodemailer
...
export async function POST(req: Request) {
  ...
  try {
    await transporter.sendMail({
      ...
      subject: 'Form Submission From Simplified Web.Dev',
    });
  } catch (error) {
